...
{
  int* ibuf=(int*)calloc(100,sizeof(int));
  char strbuf[80];
  float fbuf[12];
  ...
  for (i = 0; i < maxtag; i++)
    {
      ...
      if (nm[i])
	{
	  strcpy_s(strbuf,nm[i]);
	}
      else
	{
	  sprintf_s(strbuf,"Surface%d",i+1);
	}
   ...
   switch(flowtype)
     ...
     case UNSIO_FLOWTYPE_INCOMPRESSIBLE:
       ...
       strcpy_s(strbuf,"Pressure");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"XVelocity; Velocity");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"YVelocity");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"ZVelocity");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
     ...
     case UNSIO_FLOWTYPE_COMPRESSIBLE:
       ...
       strcpy_s(strbuf,"Density");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"XMomentum; Momentum");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"YMomentum");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"ZMomentum");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
       strcpy_s(strbuf,"TotalEnergy");
       fwrite(strbuf,sizeof(char),80,fp);
       printf("FIELDVIEW IO:\t%s\n",strbuf);
	 ...
	 {
	   sprintf_s(strbuf,"QVariable%d",i+1);
	   fwrite(strbuf,sizeof(char),80,fp);
	 }
     }
   ...
   if (minorversion >= 5)
       ...
       if (nbvariables > 0)
	 {
	   ...
	   if (nbvariables > 2)
	     {
	       strcpy_s(strbuf,"YPlus");
	       fwrite(strbuf,sizeof(char),80,fp);
	       printf("FIELDVIEW IO:\t%s\n",strbuf);
	     }
	   if (nbvariables > 3)
	     {
	       strcpy_s(strbuf,"wallY");
	       fwrite(strbuf,sizeof(char),80,fp);
	       printf("FIELDVIEW IO:\t%s\n",strbuf);
	     }
	 }
